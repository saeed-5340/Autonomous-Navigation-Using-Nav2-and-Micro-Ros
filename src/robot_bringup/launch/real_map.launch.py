...
def generate_launch_description():
    ...
    urdf_path = os.path.join(get_package_share_path('robot_description'), 'urdf', 'my_car.urdf.xacro')
    robot_description = ParameterValue(Command(['xacro ', urdf_path]), value_type=str)
    robot_rviz_path = os.path.join(get_package_share_path('robot_bringup'),'rviz','map_config.rviz')
    ...
    slam_params_path = os.path.join(pkg_path_3, 'config', 'slam_toolbox_params.yaml')
    # REAL MAPPING CODE TO ADD IF YOU DO NOT USE robot_bringup:
